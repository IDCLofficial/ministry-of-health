...
const info = {
  ...
  description: "The Imo State Ministry of Health was created by the administration of His Excellency, Distinguished Senator Hope Uzodinma: the Governor of Imo State to facilitate the transformation of Imo State ",
    quickLinks: [
        {
            label: "Projects",
            href: "/projects" 
    ...
    contact: [
        {
            label: "Block 9, State Secretariat Complex, Owerri, Imo State",
            href: "/"
        },
        {
            label: "+2348137334102",
        ...
        },  
        {
            ...
            href: "mailto:ministryofhealthprimaryhealth@gmail.com"
        },
    ]
}
...
export default function Footer() {
  ...
  return (
    ...
    <div className="mx-auto flex flex-col lg:flex-row justify-between gap-8 pb-8 max-w-5xl">
      ...
      Copyright © {new Date().getFullYear()} Imo State Ministry of Health. All rights reserved. Powered by{' '}
      <a 
