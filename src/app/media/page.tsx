...
export default function MediaPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#F7F9FA] flex flex-col">
      <MediaHeroSection
        title="Watch Us Transform the Health Sector"
        subtitle="Explore our gallery of photos, videos, and press releases showcasing our commitment to transforming the health sector in Imo State."
      ...
      <CTASection
        ...
        subtext="Be part of our mission to create a sustainable, accessible, and efficient health supply system for all communities in Imo State."
