...
export default function EventDetailPage() {
  ...
  return (
    <>
      <TopHero
        ministryName="Ensuring Sustainable Health Management for Imo State"
        titleLabel="Events"
      />
      ...
      <div className="bg-white">
        ...
        <section className="w-full max-w-6xl mx-auto px-4 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
            ...
            <div><span className="font-semibold">ORGANIZER:</span> <span className="ml-2">Imo State Ministry of Health</span></div>
        ...
        <CTASection
          heading="Join Us in Transforming Health Management"
